...
func NewServer(cfg *ServerConfig) *Server {
	...
	srv.Publisher = new(Publisher)

	// TODO Init publisher

	srv.Publisher.defaultExchange = cfg.DefaultPublishSettings.Exchange
	srv.Publisher.defaultRoutingKey = cfg.DefaultPublishSettings.RoutingKey
